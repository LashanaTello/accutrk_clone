...
class Ui_CoursesPage(object):
    def setupUi(self, CoursesPage):
        ...
        self.searchByComboBox.setMaxVisibleItems(7)
        self.searchByComboBox.setMaxCount(7)
        ...
        self.searchByComboBox.setCurrentIndex(6)
    ...
    def retranslateUi(self, CoursesPage):
        ...
        self.searchByComboBox.setCurrentText(_translate("CoursesPage", "Course Name"))
        ...
        self.searchByComboBox.setItemText(6, _translate("CoursesPage", "Course Name"))
