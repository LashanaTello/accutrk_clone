...
class Ui_SignInDialog(object):
    def setupUi(self, SignInDialog):
        ...
        item = QtWidgets.QListWidgetItem()
        self.semesterList.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.semesterList.addItem(item)
    ...
    def retranslateUi(self, SignInDialog):
        ...
        __sortingEnabled = self.semesterList.isSortingEnabled()
        self.semesterList.setSortingEnabled(False)
        item = self.semesterList.item(0)
        item.setText(_translate("SignInDialog", "fall 2030"))
        item = self.semesterList.item(1)
        item.setText(_translate("SignInDialog", "spring 2150"))
        self.semesterList.setSortingEnabled(__sortingEnabled)
